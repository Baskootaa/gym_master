...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    // معالجة رفع الصورة وتحويلها إلى Base64 لتخزينها في عمود photo
...
// جلب بيانات المستخدم المحدثة من قاعدة البيانات مباشرة
try {
...
// تجهيز عرض الصورة بطريقة آمنة وسليمة
                            ...
                            <form method="POST" action="profile.php" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <img src="<?= $current_avatar_display ?>" alt="Avatar" class="rounded-circle mt-1" width="60" height="60" style="object-fit: cover;">
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-bold">كلمة المرور الجديدة</label>
                                    <input type="password" name="password" class="form-placeholder form-control" placeholder="اتركها فارغة إذا لم ترد التغيير">
                                </div>
